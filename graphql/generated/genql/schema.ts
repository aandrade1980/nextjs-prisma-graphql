...
export interface MutationPromiseChain {
  createItem: (args: {
    ...
    get: <R extends ItemRequest>(
      request: R,
      defaultValue?: FieldsSelection<Item, R> | undefined
    ) => Promise<FieldsSelection<Item, R> | undefined>;
  };
  deleteItem: (args: {
    id: Scalars['ID'];
  }) => ItemPromiseChain & {
...
export interface MutationObservableChain {
  createItem: (args: {
    ...
    get: <R extends ItemRequest>(
      request: R,
      defaultValue?: FieldsSelection<Item, R> | undefined
    ) => Observable<FieldsSelection<Item, R> | undefined>;
  };
  deleteItem: (args: {
    id: Scalars['ID'];
  }) => ItemObservableChain & {
...
export interface QueryPromiseChain {
  getItems: ((args?: {
    ...
    get: <R extends ItemRequest>(
      request: R,
      defaultValue?: (FieldsSelection<Item, R> | undefined)[] | undefined
    ) => Promise<(FieldsSelection<Item, R> | undefined)[] | undefined>;
  }) & {
    get: <R extends ItemRequest>(
      request: R,
      defaultValue?: (FieldsSelection<Item, R> | undefined)[] | undefined
...
export interface QueryObservableChain {
  getItems: ((args?: {
    ...
    get: <R extends ItemRequest>(
      request: R,
      defaultValue?: (FieldsSelection<Item, R> | undefined)[] | undefined
    ) => Observable<(FieldsSelection<Item, R> | undefined)[] | undefined>;
  }) & {
    get: <R extends ItemRequest>(
      request: R,
      defaultValue?: (FieldsSelection<Item, R> | undefined)[] | undefined
